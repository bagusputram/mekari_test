	...
	<div class="container-fluid spark-screen">
		<div class="row">
			<div class="col-lg-12 col-12">
                <form action="{{ route('setting-menu.store') }}" method="post" class="form-officeallowance form-officeallowance-update" novalidate>
                                            ...
                                            <div class="col-md-12 col-md-offset-2">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-10 col-md-5">
                                                        <input class="form-control" type="text" id="menu_name" name="menu_name" value="">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-10 col-md-5">
                                                        <input class="form-control" type="text" id="menu_language" name="menu_language" value="">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-10 col-md-5">
                                                        <input class="form-control" type="text" id="menu_icon" name="menu_icon" value="">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-10 col-md-5">
                                                        <input class="form-control" type="text" id="menu_controller" name="menu_controller" value="">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-10 col-md-5">
                                                        <input class="form-control" type="text" id="menu_position" name="menu_position" value="">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-10 col-md-5">
                                                        <select class="form-control select" name="menu_parent_id" width>
