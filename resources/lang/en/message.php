...
return [
    ...
    */
    ...
    "title" => [
      ...
      "success" => [
        "edit" => "Data Has Been Edited Successfuly!",
        "create" => "Data Has Been Created Successfuly!",
        "approve" => "Data Has Been Sent For Approval!",
        "approve" => "Data Has Been Failed to Import!",
      ],
      "sync" => "Data Has Been Syncrhonized Successfuly!",
      "restore" => "Data Has Been Restored Successfuly!",
      "delete" => "Data Has Been Deleted Successfuly!",
      "errors" => "There was some errors",
      "no_activity" => "You do not seem to be doing the activity for",
      ...
      'different_password'  => 'Your Current Password is Wrong',
      'no-data' => 'No Data',
];
