...
class RestrictedSettingController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.manage-setting.restricted-setting.index',compact('session_timeout','application_language','languages'));
    }
}
